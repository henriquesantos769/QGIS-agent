...
from .views import (criar_projeto_qgis, enviar_para_qfieldcloud, exportar_qfield_view,
                     home, download_pacote_zip, progresso, progresso_qfield, enviar_projeto_zip_qfield,
...
urlpatterns = [
    ...
    path("exportar-qfield/", exportar_qfield_view, name="exportar_qfield"),
    ...
    path("enviar_projeto_zip_qfield/", enviar_projeto_zip_qfield, name="enviar_projeto_zip_qfield"),
]
