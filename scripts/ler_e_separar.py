...
# Caminho do DXF
path = r"Arquivo Qgis (DXF)\TESTE Q GIS - ALPHAVILLE.dxf"
layer_uri_point = path + "|layername=entities|geometrytype=Point"
layer_uri_linestring = path + "|layername=entities|geometrytype=LineString"
...
# Pastas de saída
base_path = Path(r"C:\Users\mario\Documents\estudos\instituto_legal\QGIS-agent\exportacoes")
